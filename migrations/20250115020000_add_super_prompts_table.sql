...
CREATE INDEX "idx_super_prompts_user_id" ON "public"."super_prompts" USING "btree" ("user_id");
CREATE INDEX "idx_super_prompts_ai_model" ON "public"."super_prompts" USING "btree" ("ai_model");
CREATE INDEX "idx_super_prompts_created_at" ON "public"."super_prompts" USING "btree" ("created_at");

-- Enable RLS
ALTER TABLE "public"."super_prompts" ENABLE ROW LEVEL SECURITY;

-- Create RLS policies for super_prompts
...
-- Create trigger for super_prompts updated_at
CREATE OR REPLACE TRIGGER "update_super_prompts_updated_at" 
